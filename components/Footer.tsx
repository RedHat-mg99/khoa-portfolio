        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-500 max-w-sm mb-4">
              Middle Software Tester / QA Engineer specializing in manual / automated testing and high-quality product delivery processes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li>
                <a 
                  href={`mailto:${PERSONAL_INFO.email}?subject=Let's Connect&body=--Thank you for your concern. I will reply ASAP--%0D%0A%0D%0A%0D%0A`}
